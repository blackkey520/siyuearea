module.exports = app => {
  class RestqlService extends app.Service {
    *index(modal,query, condition = {}) {
      ...
      const recordsql = "select * from (select t1.oid,t1.ordercode,t1.pid,t2.pname,t1.mid,t3.mname,t1.ostate,t1.otime,t1.pdesc,t4.btime,t4.etime,t4.money,t4.disid,t4.discount"
...
const recordsql = "select * from (select t1.rid,t1.pid,t4.pname,t1.mid,t3.mname,t1.oid,t2.ostate,t1" +
