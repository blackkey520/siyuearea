module.exports = app => {
  class RestqlService extends app.Service {
    *index(modal,query, condition = {}) {
      ...
      const recordsql = "select * from (select t1.registplace,t1.mid,t1.mmoney,t1.mdesc,t1.mname,t1.mregisttime,t1.mstate,t1.mtype,t1.phonenum,t1.mpd,t1.membercode"
+",t1.memberopenid,t1.memberprogramopenid,t2.pcname,t2.btime,t2.etime,t2.isused,t2.pcdesc,t2.`value`  from Base_Member  as t1 left join Base_ProductCard as t2 on t1.mpd=t2.pcid) as t5 "
    ...
    *findlist(modal,query, condition = {}) {
      ...
      const recordsql = "select * from (select t1.registplace,t1.mid,t1.mmoney,t1.mdesc,t1.mname,t1.mregisttime,t1.mrtime,t1.mstate,t1.mtype,t1.phonenum,t1.mpd,t1.membercode"
